...
if let activeEntitlement = customerInfo.entitlements["DictationEasy Premium"],
...
if let expirationDate = customerInfo.entitlements["DictationEasy Premium"]?.expirationDate {
